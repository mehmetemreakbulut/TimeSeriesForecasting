...
class Transformer(object):
    ...
    def __init__(self, look_back, horizon, n_features):
        ...
        self.log_dir = "log"
        self.checkpoint_dir = "parameters"
    ...
    def train(self,
        ...
        plateau_monitor = tf.keras.callbacks.ReduceLROnPlateau(
                        monitor='val_loss',
                        mode='min',
                        patience=10,
                        factor=0.1,
        ...
        callback_history = self.model.fit(X_train, y_train, validation_data = (X_val, y_val), epochs=epochs, batch_size=batch_size,
                             verbose=1,
                             callbacks=[early_stopping_monitor, checkpoint, plateau_monitor])
